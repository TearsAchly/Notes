...
There are several kinds of loops in programming.
In this section, we will focus on two common ones:

* [**For Loop**]()
  Used when the number of repetitions is known in advance.

* [**While Loop**]()
  Used when repetition depends on a condition that is checked during execution.
