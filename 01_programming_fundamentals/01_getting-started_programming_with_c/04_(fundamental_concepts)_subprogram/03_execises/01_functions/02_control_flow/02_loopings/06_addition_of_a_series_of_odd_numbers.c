...
/*
 * Function Name: calculate_odd_sum_series
 * Parameters: int N - the upper limit of the odd number series
 * Returns: void
 * Description: This function calculates and prints the sum of odd numbers from 1 to N,
 *              along with the series of odd numbers.
 */
void calculate_odd_sum_series(int N) {
...
int main() {
    ...
    // Call the function to calculate and print the odd sum series
    calculate_odd_sum_series(N);
